...
//                             });
            ...
            instagram: function() {
              $(".gl_instagram").each(function (index) {
                var $this = $(this),user_name = $this.data('username'),getBy = $this.data('getby'),
                    limit = $this.data('limit'),
                    target = $this.data('target'),
                    img_size = $this.data('size'),
                    ul_ins = $this.find(".instagram-pics");
                if (getBy == '2') {user_name = $this.data('accesstoken')}
                if (getBy == '2') {
                  $.ajax({
                    ...
                    success: function(response) {
                      ...
                      $.each(data,function(index,element){
                        ...
                        html += '<li><a href="' + element.link +'" target="'+target+'"></a><div class="wrapp-pics jas-pr-image-link nt_bg_lz lazyload" data-bgset="' + img_url_150 + ' 150w,' + img_url_320 + ' 320w,' + img_url_640 + ' 640w" data-parent-fit="cover"><div class="hover-mask"></div></div></li>';
                  ...
                  $.ajax({
                    ...
                    success: function(response) {
                      ...
                      $.each(data,function(index,element){
                        ...
                        html += '<li><a href="//instagram.com/p/'+element.code+'" target="'+target+'"></a><div class="wrapp-pics jas-pr-image-link nt_bg_lz lazyload" data-bgset="' + img_url_150 + ' 150w,' + img_url_320 + ' 320w,' + img_url_640 + ' 640w" data-parent-fit="cover"><div class="hover-mask"></div></div></li>';
